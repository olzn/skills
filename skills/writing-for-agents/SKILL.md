...
description: Writing documents for agents. Use when creating or editing skills, or modifying AGENTS.md or CLAUDE.md. Where a repo ships its own doc-writing rules, apply those on top — this is the underlying theory.
---
...
Adapted from Matt Pocock's MIT-licensed `writing-for-agents`
