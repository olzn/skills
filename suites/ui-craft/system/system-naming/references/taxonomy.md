...
|---|---|---|---|---|---|
| `Dialog` | Blocking overlay for a focused task or decision | Component, docs | Modal, popup | Modal | system-components |
| `Popover` | Anchored floating interactive content | Component, docs | Tooltip, flyout | Floating panel | system-components |
| `Tooltip` | Short non-interactive help text | Component, docs | Popover | Help bubble | system-components |
| `Toast` | Temporary low-priority feedback | Component, docs | Alert, snackbar | Snackbar | system-patterns |
| `Alert` | Persistent status message | Component, docs | Toast | Banner | system-patterns |
