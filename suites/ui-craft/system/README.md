...
Companion to surface, which covers copy, motion, interaction design, typography, colour, and platform implementation. Both suites live in the [ui-craft](https://github.com/olzn/ui-craft) repo.

---

## Suite Boundary

**system defines what the interface is made from and how those parts are named, structured, and reused.** It is the structural design-system layer: vocabulary, tokens, component contracts, and composed patterns.

Use **surface** when deciding how those parts look, read, move, respond, and feel in use: typography, copy, colour, motion, interaction behaviour, browser details, and visual polish.

Rule of thumb: if the question is "what is this thing, what is it called, and how does it fit into the reusable system?", start with system. If the question is "how should this render, read, feel, move, or behave in the browser?", use surface.
...
```
system/
├── system-naming/SKILL.md      Naming across UI, code, tokens, components, icons, and products.
├── system-tokens/SKILL.md       Design tokens and foundation scales.
├── system-components/SKILL.md   Component APIs, composition, states.
...
**system-naming** defines the vocabulary: "This is a popover, not a tooltip; this command is Delete project, not Confirm."

**system-tokens** sets up the foundation once: "Here's the spacing scale, here's how token architecture works, here's how theming works."

**system-components** uses those tokens to build individual components: "Here's a Button with consistent props, complete states, and forwarded refs."

**system-patterns** assembles those components into features: "Here's how that Button, Input, and ErrorMessage work together as a form with validation timing and error placement."

---

## How They Trigger

**"Set up the spacing and token system"**: system-tokens fires.

**"What should this component/button/feature be called?"**: system-naming fires.

**"Build a reusable Button component"**: system-components fires.

**"How should this form validate?"**: system-patterns fires.

**"Build me a dashboard"**: system-patterns fires (layout and data display patterns).

**"Where should errors show?"**: system-patterns fires.

**"This component API feels wrong"**: system-components fires.
...
**[github.com/olzn/ui-craft/tree/main/surface](https://github.com/olzn/ui-craft/tree/main/surface)**
